                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li><a href="<?php echo site_url();?>main/"><i class="fa fa-tachometer"
                        ...
                        if($dataLevel == 'is_admin'){ //Check user level if is Admin
                            ...
                            <li><a href="'.site_url().'data/lists"><i class="glyphicon glyphicon" aria-hidden="true"></i> Found</a></li>
                            <li><a href="'.site_url().'lost/lists"><i class="glyphicon glyphicon-search" aria-hidden="true"></i> Lost</a></li>
                            <li><a href="'.site_url().'main/settings"><i class="glyphicon glyphicon-cog" aria-hidden="true"></i> Settings</a></li>
                            ';

                        }
                        if($dataLevel == 'is_user'){ //Check user level if is User
                            echo'
                            <li><a href="'.site_url().'data/lists"><i class="glyphicon glyphicon" aria-hidden="true"></i> Found</a></li>
                            <li><a href="'.site_url().'lost/lists"><i class="glyphicon glyphicon-search" aria-hidden="true"></i> Lost</a></li>
                            <li><a href="'.site_url().'main/settings"><i class="glyphicon glyphicon-cog" aria-hidden="true"></i> Settings</a></li>
