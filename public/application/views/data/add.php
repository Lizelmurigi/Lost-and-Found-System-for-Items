<div class="col-lg-4 col-lg-offset-4">
    ...
    <div class="form-group">
        ...
        <input name="pic_related" id="image" type="file" multiple="true">
    </div>

    <div class="form-group">
        <?php echo form_input(array('name'=>'place_detail', 'id'=> 'place_detail', 'placeholder'=>'Place Details', 'class'=>'form-control', 'value' => set_value('place_detail'))); ?>
        <?php echo form_error('place_detail') ?>
    </div>
    <div class="form-group">
        <?php echo form_input(array('name'=>'item_details', 'id'=> 'item_details', 'placeholder'=>'Description', 'class'=>'form-control', 'value' => set_value('item_details'))); ?>
    ...
    <div class="form-group">
        <input type="date" name="pub_date" class="form-control" id="pub_date"
            value="<?php echo set_value('pub_date')?>">
