...
class Main extends CI_Controller {
    ...
    function __construct(){
        ...
        $this->load->model('Midae_model', 'Midae_model', TRUE);
	...
	public function index()
	{
        ...
        if(empty($this->session->userdata['email'])){
            ...
            $table = "items";
        $data['items'] = $this->Midae_model->get_count_product($table);
        $table = "lost";
        $data['lost'] =$this->Midae_model->get_count_product($table);
        $table = "users";
        $data['admins'] =$this->Midae_model->get_count_product($table);
